/*//////////////////////////////////////////////////////////
//Show all chords that are connected to the UK
//////////////////////////////////////////////////////////*/
function Draw11(){
	...
	changeTopText(newText = "Here are all the chords representing transactions in and out of the UK ",
		loc = 3/2, delayDisappear = 0, delayAppear = 1, finalText = true, xloc=-80, w=200);

	/*Remove the SG arc*/
	d3.selectAll(".SGLoyalArc")
		.transition().duration(1000)
		.attr("opacity", 0)
		.each("end", function() {d3.selectAll(".SGLoyalArc").remove();});

	/*Only show the chords of UK*/
	...
	/*Show only the ticks and text at UK*/
